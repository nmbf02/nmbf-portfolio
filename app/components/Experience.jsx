...
export default function Experience() {
    ...
    return (
        <section
            id="Experience"
            className="relative py-24 px-8 overflow-visible scroll-mt-28 bg-gradient-to-br from-slate-50 via-purple-50/30 to-slate-50 dark:from-gray-900 dark:via-purple-900/10 dark:to-gray-900"
        >
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12 xl:gap-16">
                    ...
                    <div className="relative flex-1 min-w-0">
                        <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-400/50 via-purple-500/50 to-purple-400/50 pointer-events-none" />
                        ...
                        <div className="space-y-12 md:space-y-16">
                            {projects.map((project) => (
                                ...
                                >
                                    <div className="absolute left-0 w-4 h-4 rounded-full border-2 border-purple-500 bg-gray-50 dark:bg-gray-900 -translate-x-1/2 z-10 mt-1.5 shrink-0 transition-colors duration-300 group-hover:bg-purple-500" />

                                    <div className="w-full ml-12">
                                        <div className="rounded-2xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 shadow-lg transition-all duration-300 group-hover:border-purple-500/40 group-hover:shadow-xl group-hover:shadow-purple-500/5 overflow-hidden">
                                            {/* Imagen */}
                                            ...
                                            <div className="p-6">
                                                ...
                                                {project.isPrivate ? (
                                                    <div className="px-4 py-3 bg-gray-100/80 dark:bg-gray-800/70 rounded-xl text-center border border-gray-300/60 dark:border-gray-700/60">
                                                    ...
                                                    <a
                                                        ...
                                                        className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 text-white rounded-xl font-bold hover:from-purple-500 hover:via-pink-500 hover:to-indigo-500 transition-all shadow-lg hover:shadow-xl"
                                                    >
